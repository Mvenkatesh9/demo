                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li>
                    ...
                    <div class="widget-profile profile-in-header">
                      <button type="button" data-toggle="dropdown" class="btn dropdown-toggle"><span class="">${sessionScope.UserName} </span><img src="${sessionScope.profiePicture.dPicture}" alt="Profile picture" style="border: 1px solid #fff"/></button>
                      <ul role="menu" class="dropdown-menu">
                        <li><a href="../sponsor/changePassword"><i class="fa fa-cog"></i>Change Password</a></li>

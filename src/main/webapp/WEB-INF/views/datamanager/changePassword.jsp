...
<html lang="en">
<head>
<title>Cliniv - Update Password</title>
<meta charset="utf-8">
		...
		<div class="login-wrapper">
			<div class="login-container">
				...
				<!--Login Form-->
						...
						<form id="loginForm" role="form" action="../datamanager/updatePassword" class="login-form" method="post" onsubmit="return validateForm()">
            ...
            <button type="submit" class="btn-dark btn-block btn-login" value="Update">SUBMIT</button>  
            </div>         
          </form>

...
public class FileIOUtil {
	...
	public static final String NOTIFICATIONS_BASE_PATH = "cliniv.notification.basepath";
	public static final String NEWS_BASE_PATH = "cliniv.news.basepath";
	public static final String TRANSFORM_BASE_PATH = "cliniv.transform.basepath";
	...
	public String writeNotificationContent(File inputFile, String notificationId,String notificationDetailId) {
		...
		try 
		{
			...
			absolutePath = ClinIVProperty.getInstance().getProperties(FileIOUtil.NOTIFICATIONS_BASE_PATH)  + File.separatorChar + notificationId +  File.separatorChar + notificationDetailId;
	...
	public String writeNewsContent(File inputFile, String newsId) {
		...
		try 
		{
			...
			absolutePath = ClinIVProperty.getInstance().getProperties(FileIOUtil.NEWS_BASE_PATH)  + File.separatorChar + newsId;
			File baseFolder = new File(absolutePath);
			if (!baseFolder.exists())
			{
				baseFolder.mkdirs();
	...
	public String writeTransformContent(File inputFile, String categoryId) {
		...
		try 
		{
			...
			absolutePath = ClinIVProperty.getInstance().getProperties(FileIOUtil.TRANSFORM_BASE_PATH)  + File.separatorChar + categoryId;
			File baseFolder = new File(absolutePath);
			if (!baseFolder.exists())
			{
				baseFolder.mkdirs();
